...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CGSize size = [string getTextSizeWithFont:[UIFont systemFontOfSize:DETAIL_FONT_SIZE] viewWidth:tableView.frame.size.width - 40 padding:0];
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([detalilText isEqualToString:@"screenShot"]) {
        ...
        cell.imageScrollView.frame = CGRectMake(0, 0, CGRectGetWidth(cell.contentView.frame), 320);
